...
通知共通基盤v2向けTypeScriptクライアント（1.28.0）。対応要件: F-013、F-014、F-015、F-019、NF-004〜NF-007、NF-013、NF-014。1.28.0はテンパリスト連携に伴う共通版更新で、通知クライアントの契約変更・公開配布は含まない。以下の1.27.0のtarball名は初回配布時の例であり、実際にpackした版へ読み替える。
